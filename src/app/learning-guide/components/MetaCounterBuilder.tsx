  ...
  return (
    <div className="space-y-8">
      ...
      <LearningGuideAIHelper
        title="Meta Counter Builder AI Helper"
        topic="Meta Counter Builder"
        ...
        context="This learning-guide page is about Meta Counter Builder in the One Piece TCG learning experience."
        prompts={[

  ...
  return (
    <div className="space-y-6">
      ...
      <LearningGuideAIHelper
        title="Game End Conditions AI Helper"
        topic="Game End Conditions"
        ...
        context="This learning-guide page is about Game End Conditions in the One Piece TCG learning experience."
        prompts={[

  ...
  return (
    <div className="space-y-6">
      ...
      <LearningGuideAIHelper
        title="Priority Actions AI Helper"
        topic="Priority Actions"
        ...
        context="This learning-guide page is about Priority Actions in the One Piece TCG learning experience."
        prompts={[

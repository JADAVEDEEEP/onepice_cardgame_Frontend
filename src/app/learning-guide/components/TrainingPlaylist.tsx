  ...
  return (
    <div className="space-y-8">
      ...
      <LearningGuideAIHelper
        title="Training Playlist AI Helper"
        topic="Training Playlist"
        ...
        context="This learning-guide page is about Training Playlist in the One Piece TCG learning experience."
        prompts={[
